...
function stringify(src) {
    ...
    if ((src === null) || (src === undefined))
        return null;
    if (typeof src === 'object') {
        var objectValue = null; // tslint:disable-line:no-any
        var objectString = null; // tslint:disable-line:no-any
        if (typeof src.valueOf === 'function') {
...
//# sourceMappingURL=Conversely.js.map